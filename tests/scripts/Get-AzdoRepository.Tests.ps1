...
Describe 'Parameter Validation'{
    ...
    Context 'Parameter Validation'{
        ...
        it 'project is mandatory'{
            $commandProps.Parameters.project.Attributes.Mandatory | Should -BeTrue
        }

        it 'repository is mandatory'{
            $commandProps.Parameters.repository.Attributes.Mandatory | Should -BeTrue
        }
