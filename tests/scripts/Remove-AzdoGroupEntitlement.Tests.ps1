...
Describe 'Parameter Validation'{
    ...
    Context 'Parameter Validation'{
        ...
        it 'azdoGroupId should be mandatory'{
            $commandProps.Parameters.azdoGroupId.Attributes.Mandatory | Should -BeTrue
        }

        it 'removeGroupMembership should be optional'{
            $commandProps.Parameters.removeGroupMembership.Attributes.Mandatory | Should -BeFalse
        }

        it 'whatIf should be optional'{
            $commandProps.Parameters.whatIf.Attributes.Mandatory | Should -BeFalse
        }
